...
public class ErrorFactory {
	...
	private final static Map<Integer, String> generateErrorMapping() {
		...
		hashMap.put(FAIXA_DATA_INSCRICOES_INVALIDA, "Faixa de data de inscrições inválida. A data final deve ser maior ou igual a inicial");
		hashMap.put(FAIXA_DATA_FORM_INVALIDA, "Faixa de data de formulários inválida.A data final deve ser maior ou igual a inicial");
		hashMap.put(NOME_FAMILIAR_INVALIDO, "Nome do familiar inválido.Insira apenas letras");
		hashMap.put(IDADE_FAMILIAR_INVALIDA, "Idade do familiar inválido.O número deve ser um inteiro positivo");
		hashMap.put(GRAU_DE_INSTRUCAO_FAMILIAR_INVALIDA, "Grau de instrução do familiar inválido. o número deve ser um inteiro positivo.");
		hashMap.put(PROFISSAO_FAMILIAR_INVALIDA, "Profissão do familiar inválida.Insira apenas letras.");
		hashMap.put(RENDA_FAMILIAR_INVALIDA, "Renda do familiar inválida.O número deve ser positivo");
		hashMap.put(DOENCA_FAMILIAR_INVALIDA, "Doença do familiar inválida.Insira apenas letras.");
		hashMap.put(NOME_IF_INVALIDO, "Nome da instituição financiadora inválido.Insira apenas letras");
		hashMap.put(CNPJ_INVALIDO, "CNPJ inválido.");
		hashMap.put(ORCAMENTO_AUXILIO_INVALIDO, "Orçamento do auxílio inválido.O número deve ser positvo");
		hashMap.put(RENDA_FAMILIAR_TOTAL_INVALIDA, "Situação em relação a renda inválida.Insira apenas letras.");
		hashMap.put(MORADIA_INVALIDA, "Moradia inválida.Insira apenas letras.");
		hashMap.put(SITUACAO_MORADIA_INVALIDA, "Situação de moradia inválida.Insira apenas letras");
		hashMap.put(RESIDENCIA_FAMILIAR_INVALIDA, "Residência familiar inválida.Insira apenas letras");
		hashMap.put(SITUACAO_TRABALHO_INVALIDA, "Situação em relação ao trabalho inválida.Insira apenas letras");
		hashMap.put(ALUGUEL_INVALIDO, "Gastos com aluguel inválido.O número deve ser positivo");
		hashMap.put(CONDOMINIO_INVALIDO, "Gastos com condominio invalido.O número deve ser positivo");
		hashMap.put(LUZ_INVALIDA, "Gastos com luz inválido.O número deve ser positivo");
		hashMap.put(AGUA_INVALIDA, "Gastos com água inválido.O número deve ser positivo");
		hashMap.put(TELEFONE_INVALIDO, "Gastos com telefone inválido.O número deve ser positivo");
		hashMap.put(FINANCIAMENTO_CASA_PROPRIA_INVALIDO, "Gastos com o financiamento da casa própia inválido.O número deve ser positivo");
